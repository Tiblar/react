...
function DisableTwoFactorEmail(props) {
    ...
    function handleSubmit() {
        ...
        axios.delete(API_URL + '/auth/two-factor/email/' + props.match.params.code, config)
            .then(function (res) {
        ...
        <Container>
            {
                ...
                <div className={formStyles.formGroup}>
                    <p>You are removing two factor.</p>
                </div>
            }
            ...
            <div style={{display: manager.confirmed && !manager.notFound ? "block" : "none"}}>
                <div className={formStyles.alert + ' ' + layoutStyles.mB1}>
                    <ConfirmIcon height={16} /> Disabled two factor
                </div>
                <hr />
                <p className={layoutStyles.mT1}>
                    You have disabled two factor authentication through your email.
                </p>
            </div>
            <div style={{display: manager.notFound ? "block" : "none"}}>
                ...
                <hr />
                <p className={layoutStyles.mT1}>
                    The code may be expired or you may have already disabled two factor, you can request a new code in your settings.
                </p>
            </div>
        </Container>
    );
...
export default connect(mapStateToProps)(DisableTwoFactorEmail);
