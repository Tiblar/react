...
import {
    ...
    INVOICE_STATUS_REFUNDED, PAYMENT_METHOD_BITCOIN,
    PAYMENT_METHOD_CREDIT_CARD_STRIPE,
    PAYMENT_METHOD_CRYPTOCURRENCY, PAYMENT_METHOD_MONERO,
            ...
            <div className={layoutStyles.flexGrow}>
                ...
                </div>
                {
                    ...
                    <div>
                        ...
                        <div className={layoutStyles.flex}>
                            {
                                invoice.payment_method.type === PAYMENT_METHOD_BITCOIN &&
                                <h4>Bitcoin Transaction</h4>
                            }
                            {
                                invoice.payment_method.type === PAYMENT_METHOD_MONERO &&
                                <h4>Monero Transaction</h4>
                            }
                            <div className={layoutStyles.mL}>
                                {
